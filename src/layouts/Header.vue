        ...
        <div class="container-fluid px-0">
            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item dropdown ms-lg-3">
                    <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" v-if="IsLogin">
...
export default {
    ...
    methods: {
        logout:function() {
            this.$http.post('https://dbaca83cc141.ngrok.io/api/logout',{}, {headers: { authorization: `Bearer ${this.$store.getters.getToken}`}})
            .then(response =>{
